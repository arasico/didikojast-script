                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-10 col-md-12 text-right ">
                            ...
                            <h4 style="padding-top: 2rem;">
                                <span style="color: #da2121;">کاربر گرامی ،</span><span>پست جدید شما با موفقیت ثبت شد.</span>
                            </h4>
                            <h5>
                                <span style="color: #2e2d2d;">پس از تائید توسط دیدی کجاست ، به اشتراک گذاشته خواهد شد.</span>
                            </h5>
                        </div>
                    </div>
                    ...
                    <form method="POST" action="{{url('advertisement')}}@if(isset($editValue))/{{$editValue->id}}@endif"
                            ...
                            <div class="col-lg-6 col-sm-12">
                                <div class="arasico-radio-searching">
                                    <p>
                                        ...
                                        <label class="lbl-radio-text" for="found"> پیدا کردم</label>
                                    </p>
                                </div>
                            </div>
                            <div class="col-lg-6 col-sm-12">
                                <div class="arasico-radio-searching">
                                    <p>
                                        ...
                                        <label class="lbl-radio-text" for="lost"> گم کردم</label>
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="input-group arasico-margin-botton" style="margin-top: 20px;">
                            ...
                            <input type="text" required id="title" name="title"
                                   ...
                                   class="col arasico-input-box" placeholder="عنوان چیزی که پیدا کردید؟">
                        </div>
                        ...
                        <div dir="rtl" class="arasico-margin-botton">
                        ...
                        <div class="input-group arasico-margin-botton" style="margin-top: 20px;">
                            <input type="text" required id="address" name="address"
                                   ...
                                   class="col arasico-input-box" placeholder="نشانی کامل محل">
                        </div>

                        <div class="input-group arasico-margin-botton" style="margin-top: 20px;">

                            <div class="col  text-right" style="padding-top: 10px; color: #d4d7d6;">تاریخ گمشدن</div>
                            <div class="col">
                        ...
                        <textarea id="description" name="description" class="  arasico-input-box "
                                  placeholder="توضیحات و اطلاعات بیشتر"
                                  rows="3">{{old('description')}}@if(isset($editValue)){{$editValue->description}}@endif</textarea>
                        </div>


                        <div class="text-center">
                            <button class="btn  btn-save-ads col-lg-6 col-sm-12" type="submit"> ثبت کن و به اشتراک
                                بگذار
                            </button>
                            <button class="btn   btn-cancel-ads col-lg-3 col-sm-12"
                                    onclick="location.href='{{url('')}}'" type="submit"> انصراف
                            </button>
