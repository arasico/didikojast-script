...
<main>
    ...
    <div class="container  register-continer" style="background-color: #fff; padding: 20px; border-radius: 10px;">
        ...
        <form action="{{url('changeForgetPassword')}}" method="post" id="confirmPassword">
            ...
            <p dir="rtl" style="padding-top: 40px; text-align: right;">لطفا کلمه عبور جدید خودرا وارد نمائید.</p>
            ...
            <div class="input-group arasico-margin-botton">
                ...
                <input type="password" class="col-lg arasico-input-box" placeholder="تکرار کلمه عبور"
                       name="password_confirmation" required autofocus>
            </div>
            <div class="form-group">
                <button type="submit" class="btn btn-gereen-see-more btn-lg col-4">ذخیره</button>
        ...
        <form action="" id="sucsess" class="text-center " style="display: none;">
            ...
            <h4 dir="rtl" class="text-center" style="padding-top: 20px;">کلمه عبور شما ذخیره شده است.</h4>

            <button type="button" onclick="location.href='{{url('login')}}'" class="btn btn-gereen-see-more btn-lg">ورود
                به
                حساب کاربری
            </button>
