...
<main>
    ...
    <div class="container  register-continer" style="background-color: #fff; padding: 20px; border-radius: 10px;">
        ...
        <div class="tab   row">
            <button id="tabRegister" class="tablinks col" onclick="openTab(event, 'register')"> عضویت <i
                        class="fa fa-2x fa-user"
                        aria-hidden="true"></i></button>
            <button id="tablogin" class="tablinks col" onclick="openTab(event, 'login')"> ورود <i
            ...
            <div dir="rtl" id="register" class="tabcontent  text-right">
                @if(Session::get('success')!=null)
                    <div id="sucMessageRegister" style="display: none;" class="text-center">
                        ...
                        <h4 class="text-center" style="padding-top: 20px;">عضویت شما انجام شد.</h4>
                        <p class="text-center" style="padding-top: 10px;">لطفا جهت فعال سازی حساب کاربری خود به ایمیل
                            خود
                            مراجعه
                            نمائید. </p>
                        <div class="col-lg-12">
                            <a href="{{url('login')}}">
                                <div class=" arasico-btn-cancel col-lg-12">بازگشت</div>
                            </a>
                        </div>
                    </div>
                @endif
                ...
                <div id="registerPanel">
                    <p style="padding-top: 10px;">جهت عضویت در دیدی کجاست ، لطفا اطلاعات زیر را وارد نمائید.</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <button type="submit" class="arasico-btn-green-submit col-lg-12"> ثبت نام</button>
                        </div>
                    </div>
        ...
        <form action="{{url('login')}}" method="post">
            ...
            <div dir="rtl" id="login" class="tabcontent text-right">
                ...
                <p style="padding-top: 40px;">جهت ورود به حساب کاربری خود ، لطفا اطلاعات زیر را وارد نمائید.</p>

                <div class="input-group arasico-margin-botton">

                    <input type="text" class="col-lg arasico-input-box" placeholder="پست الکترونیک / شماره همراه"
                ...
                <div class="input-group arasico-margin-botton">
                    ...
                    <input type="password" class="col-lg arasico-input-box" placeholder="کلمه عبور"
                           aria-label="Username"
                ...
                <div class="row">
                    <div class="col-7">
                        <a href="#" onclick="openTab(event, 'forget')"><p style="padding-top: 12px;">کلمه عبور خود را
                                فراموش
                                کردم !</p></a>
                    </div>
                    <div class="col-5">
                        <button type="submit" class=" arasico-btn-green-submit ">ورود</button>
                    </div>
                </div>
        ...
        <div dir="rtl" id="forget" class="tabcontent text-right">
            ...
            <div id="forgetpassword">
                <h4 style="padding-top: 40px;">کلمه عبور خود را فراموش کردید؟</h4>
                <p style="padding-top: 10px;">جهت دریافت کلمه عبور جدید، لطفا ایمیل خود را وارد کنید.</p>
                ...
                <form action="{{url('forgetPassword')}}" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <button type="submit" class=" arasico-btn-green-submit col-lg-12">ارسال کلمه عبور جدید
                            </button>
                        </div>
                    </div>
                </form>
            ...
            <div id="sucMessage" style="display: none;" class="text-center">
                ...
                <img src="{{asset('web/img/icon-sucsses.png')}}" alt="Smiley face" height="150" width="150">
                <h4 class="text-center" style="padding-top: 20px;">کلمه عبور جدید برای ایمیل شما ارسال شد.</h4>
                <p class="text-center" style="padding-top: 10px;">جهت مشاهده کلمه عبور جدید لطفا به ایمیل خود مراجعه
                    نمائید. </p>
                <div class="col-lg-12">
