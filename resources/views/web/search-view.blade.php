...
@section('content')
            ...
            <div class="col-lg-12">
                <div class="row arasico-date-style-text">
                    @if($advertisementInfo->type=="lost")
                        <span> تاریخ گمشدن : </span>
                    @elseif($advertisementInfo->type=="found")
                        <span> تاریخ پیدا شدن : </span>
                    @endif
                    <span> {{jDate::forge(date('Y/m/d', (integer)$advertisementInfo->publish_at))->format('%d/%B/%Y')}} </span>
                </div>
            </div>
            <div class="col-lg-4" style="padding-top: 50px;">
                <div id="myBtn" class="col-lg-11 btn-gereen-see-more btn-margin">مشاهده اطلاعات تماس</div>
            </div>
    ...
    <div id="myModal" class="modal">
        ...
        <div class="modal-content">
            ...
            <p> <span>{{$advertisementInfo->email}}</span> : <span>پست الکترونیک </span></p>
            <hr width="300">
            <p><span>تلفن همراه :</span> <span>{{$advertisementInfo->phone}}</span></p>
    ...
    <div id="myModalbeforlogin" class="modal">
        ...
        <div class="modal-content">
            ...
            <p dir="rtl" style="padding-top: 10px;"> جهت مشاهده اطلاعات ، لطفا وارد حساب کاربری خود شوید.</p>
            ...
            <div class="container row arasico-div-center text-center">
                <div class="col-lg-6" style="padding-top: 50px;">
                    <div onclick="location.href='{{url('login')}}'"
                         class="col-lg-11 btn-gereen-see-more btn-margin">ورود به حساب کاربری
                    </div>
                </div>
                <div class="col-lg-6" style="padding-top: 50px;">
                    <div onclick="location.href='{{url('login')}}'"
                         class="col-lg-11 btn-gereen-see-more btn-margin">عضویت
                    </div>
                </div>
